...
static int do_mk_user_data_weir(char **arg, char reply[REPLY_MAX])
{
    return make_user_data_weir(arg[0], atoi(arg[1]), atoi(arg[2]), arg[3], arg[4]);
                             /* pkgname, uid, userid, seinfo, weirinfo */
}
...
struct cmdinfo cmds[] = {
    ...
    { "mkuserdataweir",       5, do_mk_user_data_weir },
